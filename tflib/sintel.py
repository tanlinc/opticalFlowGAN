# NVIDIA/flownet2-pytorch/blob/master/datasets.py: https://github.com/NVIDIA/flownet2-pytorch
import tensorflow as tf 
# torch.utils.data as data --> data.Dataset
...
class MpiSintel(tf.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        images = tf.convert_to_tensor(images.astype(np.float32))  #torch.from_numpy
        flow = tf.convert_to_tensor(flow.astype(np.float32))   # torch
